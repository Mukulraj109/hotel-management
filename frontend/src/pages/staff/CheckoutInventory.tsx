...
export default function CheckoutInventory() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Checkout Inventory Management</h1>
        <p className="text-gray-600">Manage guest checkout inventory checks and billing</p>
      </div>
