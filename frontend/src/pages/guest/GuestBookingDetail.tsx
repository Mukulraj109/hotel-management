            ...
            <div className="relative z-10">
              <div className="flex items-start justify-between flex-wrap gap-4">
                ...
                <div className="flex flex-col items-end gap-2">
                  <Badge variant={getStatusColor(booking.status) as any} className="text-xs px-3 py-1">
                    {getStatusIcon(booking.status)}
                    <span className="ml-1.5 capitalize">{booking.status.replace('_', ' ')}</span>
                  </Badge>
                  <Badge variant={getPaymentStatusColor(booking.paymentStatus) as any} className="text-xs px-3 py-1">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                {booking.rooms.map((room, index) => (
                  <div key={index} className="bg-gray-50 rounded-xl p-4 border border-gray-200 hover:border-yellow-300 transition-colors">
