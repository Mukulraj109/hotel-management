              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="flex items-center">
                    ...
                    {app.name}
                    <Badge variant={getStatusColor(app.status) as unknown} className="ml-2">
                      {app.status}
                    </Badge>
                  </CardTitle>
          ...
          <Card className="w-full max-w-md">
            ...
            <CardContent className="space-y-4">
              ...
              <Select
                ...
                onValueChange={(value: Record<string, unknown>) => setNewNotification({...newNotification, targetAudience: value})}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
              ...
              <Select
                ...
                onValueChange={(value: Record<string, unknown>) => setNewNotification({...newNotification, platform: value})}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
