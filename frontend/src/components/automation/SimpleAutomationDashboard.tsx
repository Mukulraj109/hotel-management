          ...
          <div className="p-4 sm:p-6">
            <div className="space-y-3 sm:space-y-4">
              {automationSteps.map((step, index) => (
                <div key={`automationSteps-${index}-${step.name}`} className="bg-gradient-to-r from-gray-50 to-gray-100/50 rounded-2xl p-3 sm:p-4 border border-gray-200/50 hover:shadow-lg transition-all duration-200 relative overflow-hidden">
                  {/* Progress indicator */}
