...
const EnhancedTapeChartView: React.FC = () => {
  ...
  const [draggedReservation, setDraggedReservation] = useState<unknown>(null);
  ...
  const handleDragStart = useCallback((e: React.DragEvent, reservation: Record<string, unknown>) => {
    ...
    nameDiv.textContent = reservation.guestName;
    const nightsDiv = document.createElement('div');
    nightsDiv.className = 'text-sm';
    nightsDiv.textContent = `${reservation.nights} nights`;
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar
                    ...
                    onSelect={(range: Record<string, unknown>) => {
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value: Record<string, unknown>) => setQuickBookingData({ 
                      ...quickBookingData, 
                      bookingType: value 
                    })}
                  >
