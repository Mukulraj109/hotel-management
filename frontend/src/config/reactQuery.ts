...
export const queryKeys = {
  ...
  properties: {
    ...
    list: (filters?: any) => [...queryKeys.properties.all, 'list', filters] as const,
  ...
  auditLogs: {
    ...
    list: (filters?: any) => [...queryKeys.auditLogs.all, 'list', filters] as const,
    stats: (dateRange?: any) =>
  ...
  scheduledUpdates: {
    ...
    list: (filters?: any) => [...queryKeys.scheduledUpdates.all, 'list', filters] as const,
  ...
  bookings: {
    ...
    list: (filters?: any) => [...queryKeys.bookings.all, 'list', filters] as const,
  ...
  guests: {
    all: ['guests'] as const,
    list: (filters?: any) => [...queryKeys.guests.all, 'list', filters] as const,
  ...
  dashboard: {
    ...
    revenue: (propertyId?: string, dateRange?: any) =>
